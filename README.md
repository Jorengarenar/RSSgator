Some time ago I had an idea for self-hosted RSS service á la Google Reader, but never done anything more than playing with [GNU Libmicrohttpd](https://www.gnu.org/software/libmicrohttpd) tutorial.
